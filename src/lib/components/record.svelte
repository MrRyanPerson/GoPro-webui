...
<div class="p-4 rounded-box shadow-sm bg-base-200">
    ...
    <div class="flex">
        <button onclick={d_record} class="mx-2 btn btn-block size-36 rounded-box bg-success flex justify-center items-center">
        ...
        <button onclick={d_stop_record} class="size-36 btn btn-block rounded-box bg-error">
